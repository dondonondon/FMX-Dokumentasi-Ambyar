...
uses frMain, uFunc, uMain, uDM, uOpenUrl, uRest;
...
begin
  ...
  TTask.Run(procedure begin
    ...
    TThread.Synchronize(nil, procedure begin
      ...
      FLoading.Anchors := [TAnchorKind.akLeft, TAnchorKind.akTop, TAnchorKind.akRight, TAnchorKind.akBottom];
    end);
  end).Start;
