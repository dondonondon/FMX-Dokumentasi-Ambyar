...
uses
  ...
  System.Net.HttpClient, System.Net.HttpClientComponent, IdMultipartFormData,
...
const
  {$IF DEFINED(IOS) or DEFINED(ANDROID)}
      url = 'https://www.blangkon.net/API/Template/APITemplate.php?key=apiapi&act=';
  {$ELSE}
      //url = 'http://localhost/appru/API/Template/APITemplate.php?key=apiapi&act=';
      url = 'https://www.blangkon.net/API/Template/APITemplate.php?key=apiapi&act=';
  {$ENDIF}
